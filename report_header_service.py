...
class ReportHeaderError(Exception):
    pass
...
def build_official_report_header(report_title: str, fiscal_year_id: int | None = None, facility_id: int | None = None, branch_id: int | None = None, period_label: str | None = None) -> dict:
    ...
    try:
        ...
        if period_label:
            ...
            resolved_period = f"FOR THE PERIOD / FISCAL YEAR {fiscal_year_name}"
        else:
            resolved_period = ""
        ...
        return {
            ...
            "is_consolidated": False if facility_name else True,
        }
    finally:
        session.close()
